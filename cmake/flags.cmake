...
if (CMAKE_CXX_COMPILER_ID MATCHES GNU)
    ...
    elseif (XMRIG_ARMv7)
        set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} -mcpu=cortex-a53 -mfpu=crypto-neon-fp-armv8 -funsafe-math-optimizations -mneon-for-64bits")
        set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -O2 -march=armv8-a+crc -mcpu=cortex-a53 -mfpu=crypto-neon-fp-armv8 -funsafe-math-optimizations -mneon-for-64bits -flax-vector-conversions")
    else()
